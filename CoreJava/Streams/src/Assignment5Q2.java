...
public class Assignment5Q2 {
	...
	public static void main(String[] args) {
		...
		News news1 = new News(1, "Prajwal", "Bisht", "comment");
        News news2 =new News(2, "Prajwal1", "Bisht1", "budget");
        News news3 = new News(1, "Prajwal2", "Bisht2", "comment");
        News news4 = new News(3, "Prajwal3", "Bisht", "budget");
        News news5 = new News(1, "Prajwal4", "Bisht2", "comment");
        News news6 = new News(3, "Prajwal5", "Bisht", "budget");
        News news7 = new News(1, "Prajwal6", "Bisht6" ,"comment");
